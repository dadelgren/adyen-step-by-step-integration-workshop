...
public class WebhookResource {
    ...
    @Autowired
    public WebhookResource(ApplicationConfiguration applicationConfiguration, HMACValidator hmacValidator) {
        this.applicationConfiguration = applicationConfiguration;

        if (this.applicationConfiguration.getAdyenHmacKey() == null) {
            ...
            try {
                ...
                if(item.isSuccess()) {
                    ...
                    if (item.getEventCode().equals("RECURRING_CONTRACT") && item.getAdditionalData() != null && item.getAdditionalData().get("recurring.shopperReference") != null) {
                        ...
                        // save token (Storage utility removed - implement your own storage logic here)
